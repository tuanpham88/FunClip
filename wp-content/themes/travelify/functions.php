...
if ( ! function_exists( 'travelify_setup' ) ):
	...
	function travelify_setup() {
		...
		add_image_size( 'featured', 670, 376, true );
		add_image_size( 'featured-medium', 230, 230, true );
		add_image_size( 'slider', 1018, 572, true );        // used on Featured Slider on Homepage Header
		add_image_size( 'gallery', 474, 266, true );                // used to show gallery all images
